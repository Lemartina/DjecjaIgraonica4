 ...
 */
package novoselac.controllerweb;
...
@WebServlet("/JavaServletObrazac")
public class JavaServletObrazac extends HttpServlet {
	...
	Statement st = con.createStatement();
        st.executeUpdate("insert into dijete(ime, imeRoditelja, oib, prezime, telefonRoditelja ) "
                + "values ('"+ime+"', '"+imeRoditelja+"', '"+oib+"', '"+prezime+"', '"+telefonRoditelja+"')");
